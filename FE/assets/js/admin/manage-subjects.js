  ...
  try {
    ...
    if (subjectList.length === 0) {
      subjectTable.innerHTML =
        '<tr><td colspan="5" style="text-align: center;">Không có dữ liệu môn học.</td></tr>';
      return;
    }

    const rowsHtml = subjectList
      .map(
        (subject) => `
            <tr>
    ...
    if (subjectTable) {
      subjectTable.innerHTML =
        '<tr><td colspan="5" style="text-align: center;">Lỗi khi tải dữ liệu. Vui lòng thử lại.</td></tr>';
    }
  }
}
